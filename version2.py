...
@app.route('/api/sd/test', methods=['GET'])
...
# Add dedicated endpoints for Prometheus service discovery with more flexible filtering
...
def prometheus_sd(protocol):
    ...
    for target in enabled_targets:
        ...
        if (protocol_lower in probe_type or 
            (protocol_lower == 'icmp' and 'ping' in probe_type) or
